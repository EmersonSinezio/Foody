      ...
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <div className="md:flex md:items-center md:gap-12">
            <Link
              className="block text-yellow-300 hover:text-yellow-600 transition-all duration-300"
              to={"/"}
            >
          ...
          <div className="flex items-center gap-4">
            <div className="sm:flex sm:gap-4">
              <Link
                className="rounded-md bg-yellow-500 px-5 py-2.5 text-sm font-medium text-white shadow hover:bg-yellow-600 transition-all duration-300"
                to="/cart"
              >
                Ver carrinho
                {totalItems > 0 && (
